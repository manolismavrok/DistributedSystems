...
public class Validations {
    ...
    public Validations(int id, String firstName, String lastName, String email, String phoneNumber, String city, String address1, String address2, String zip, String unemplDate, String photo, String validated, String confirmed) {
        super();
        this.id = id;
